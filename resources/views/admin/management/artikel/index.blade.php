...
<div class="mb-3">
  <nav class="navbar navbar-example navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid" style="justify-content: start">
        <a class="btn btn-primary btn-sm" href="{{url('admin/artikel/create')}}"><i class='bx bx-plus'></i>&nbsp;tambah data</a>
        </div>
    </nav>
  </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="javascript:void(0)" onclick="hapus('{{url('admin/artikel/destroy/'.$key->id)}}')" class="btn btn-sm btn-danger">delete</a>
                </td>
              </tr>
              @endforeach
            </tbody>
