...
<div class="row mb-3">
    ...
    <div class="row">
        <div class="col-sm-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">{{$title}} {{$row->position}}</h4>
              <form class="forms-sample" method="POST" action="{{url('admin/content/update')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mt-20">
                  <a class="btn btn-success" href="{{url('admin/content/'.$row->position)}}"><i class="mdi mdi-arrow-left-thick"></i>&nbsp;Back</a>
