                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:void(0)" onclick="hapus('{{url('admin/galery/destroy/'.$key->id)}}')" class="btn btn-sm btn-danger">delete</a>
                            </td>
                          </tr>
                          ...
                          <div class="modal fade" id="edit{{$key->id}}" tabindex="-1" aria-labelledby="create" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <form action="{{url('admin/galery/update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
    ...
    <div class="modal fade" id="create" tabindex="-1" aria-labelledby="create" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{url('admin/galery/store')}}" method="POST" enctype="multipart/form-data">
                @csrf
