                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:void(0)" onclick="hapus('{{url('admin/home_content_destroy/'.$type.'/'.$key->id)}}')" class="btn btn-sm btn-danger">delete</a>
                            </td>
                          </tr>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h1 class="modal-title fs-5" id="exampleModalLabel">Home Spesifikasi</h1>
                                ...
                                <form action="{{url('admin/home_content/update')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="type" value="spesifikasi">
