...
@section('content')
    ...
    <div class="row mb-3">
      <div class="col-sm-12">
        <a href="{{url('admin/project_content/'.$project_id)}}"><i class="mdi mdi-chevron-left"></i> back to menu</a>
      </div>
    </div>
            ...
            <div class="card-body">
              ...
              <form class="forms-sample" method="POST" action="{{url('admin/project_content/store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group mt-20">
                  <a class="btn btn-success" href="{{url('admin/project_content/'.$project_id)}}"><i class="mdi mdi-arrow-left-thick"></i>&nbsp;Back</a>
